...
def run_topology_analysis():
    ...
    graph_generators = {
        ...
        'Stripped Weights': lambda n: strip_weights(generate_weighted_graph(n)),
...
with open('c:/Users/Unknown/Documents/Repos/aa-course-repo/Lab3/tree_comprehensive_analysis.py', 'w', encoding='utf-8') as f:
    f.write(content)
